 ...
 */
public class FrmVerDetalleVenta extends javax.swing.JFrame {

    /**
     * Creates new form FrmVerDetalleVenta
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmVerDetalleVenta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmVerDetalleVenta().setVisible(true);
            }
        });
    }
